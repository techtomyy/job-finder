...
export default function Sidebar({ user }: SidebarProps) {
  ...
  const navigation = [
    ...
    { name: "Job Matches", icon: Briefcase, href: "/matches" },
    { name: "Tailored Resumes", icon: FileText, href: "/tailor" },
    { name: "Keywords", icon: Key, href: "/keywords" },
    { name: "Application Tracker", icon: TrendingUp, href: "/tracker" },
  ];
        ...
        {navigation.map((item) => {
          ...
          return (
            <Link
              ...
              style={isActive ? { boxShadow: "0 2px 8px rgba(0,0,0,0.12)" } : {}}
